...
export interface IUser extends Document {
  ...
  // recentResults?: Array<{...}>         - Use MedicalRecord.find({ patientId }).select("labResults")
  // activePrescriptions?: Array<{...}>   - Use MedicalRecord.find({ patientId }).select("prescription")
  // notifications?: Array<{...}>         - Use Notification collection
}
...
const UserSchema = new Schema<IUser>(
  {
    ...
    // are now managed separately through dedicated collections (Appointment and MedicalRecord)
    // and NOT stored directly in User document to keep it clean for new patients
  },
  {
    timestamps: true,
  },
